...
if (!isset($_SESSION['csrf_admin_laporan']) || !is_string($_SESSION['csrf_admin_laporan'])) {
    $_SESSION['csrf_admin_laporan'] = bin2hex(random_bytes(24));
}
$csrf = $_SESSION['csrf_admin_laporan'];
