...
$tampil_bayar = $status === 'pending' && !$batal;
...
<main class="pesanan-wrap pd-wrap" id="utama">
    ...
    <?php
    $kelas_layout_simetris = 'pd-layout-simetris';
    if ($timeline_events === []) {
        $kelas_layout_simetris .= ' pd-layout-simetris--tanpa-timeline';
    }
    ?>
    <div class="<?php echo htmlspecialchars($kelas_layout_simetris, ENT_QUOTES, 'UTF-8'); ?>">
            <section class="pd-card pd-layout-simetris__produk" aria-labelledby="judul-produk-pesanan">
            ...
            <div class="pd-layout-simetris__kanan-atas" aria-label="Pembayaran dan pengiriman">
            <?php if ($tampil_bayar): ?>
            <div class="pd-card pd-card--bayar">
                ...
                <?php else: ?>
                <p class="pesanan-peringatan" role="alert">Pakasir belum terhubung di server ini. Hubungi admin toko atau coba lagi nanti.</p>
                <?php endif; ?>
            </div>
            <?php endif; ?>

            <div class="pd-card pd-layout-simetris__pengiriman">
            ...
            <div class="pd-card pd-layout-simetris__ringkasan">
            ...
            <?php if ($timeline_events !== []): ?>
            <section class="pd-card pd-card--timeline pd-layout-simetris__timeline" aria-labelledby="judul-timeline-pesanan">
                <h2 id="judul-timeline-pesanan" class="pd-card__judul">Aktivitas pesanan</h2>
            ...
            <section class="pd-card pd-layout-simetris__ringkasan" aria-labelledby="judul-ringkasan-pesanan">
                <h2 id="judul-ringkasan-pesanan" class="pd-card__judul">Ringkasan pembayaran</h2>
                <dl class="pd-harga-list">
                    <div class="pd-harga-baris">
                        <dt>Metode pembayaran</dt>
                        <dd>
            ...
            <?php if ($wa_pesanan !== ''): ?>
                <a class="pd-layout-simetris__wa pesanan-bantuan-wa" href="<?php echo htmlspecialchars($wa_pesanan, ENT_QUOTES, 'UTF-8'); ?>" target="_blank" rel="noopener noreferrer">
